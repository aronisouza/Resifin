          ...
          ?>
            <li class="list-group-item list-group-item-action <?= $_corLista;?>">
              <div class="row">
                ...
                <?= $dado['FaturaPaga'] == 0 ? "
                    <button type='button' class='btn btn-outline-secondary btn-sm' id-parcela='{$dado['id']}' IdContasPagar='{$dado['IdContasPagar']}' data-bs-toggle='modal' data-bs-target='#marcarComoPago'>
                      PAGAR
                    </button>
